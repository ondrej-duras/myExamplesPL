...
#print sshExec("LAB-XXX-34","user",$CMD);  # NX-OS (default prompt is usually fine, but "cisco" can be used instead)
#print sshExec("LAB-XXX-98","user",$CMD);  # IOS   (default prompt is usually fine, but "cisco" can be used instead)
#print sshExec("LAB-XXX-70","user",$JCMD); # Junos (default prompt is usually fine, but "junos" can be used instaed)
#print sshExec("LAB-XXX-52-01","user",$F5CMD,"f5"); # F5 uses a specific predefined prompt
print raw2Csv(sshExec("LAB-XXX-34","user",rawList2Cmd($RL_NX9K)));
print raw2Instant(sshExec("LAB-XXX-34","user",rawList2Cmd($RL_NX9K)),{},"unknown"); # if we want trace unsuported classes
print raw2Instant(sshExec("LAB-XXX-34","user",rawList2Cmd($RL_NX9K)),{});  # Default behaviour, same as rawOutput2Csv
